...
const Color appPrimaryColor = Color(0xFF00C802); //
const Color appPrimaryLightColor = Color(0xFFFFFFFF); //
const Color appPrimaryColorSecondary = Color(0xFFFFFFFF); //
const Color appGradientColor = Color(0xFF79D98E); //
const Color appBackgroundColor = Color(0xFF181D20);

const Color appBackgroundColorSecondary = Color(0xFF0C0C0C); //
const Color colorSchemaSecondaryColor = Color(0xFFFFFFFF); //
const Color appBorderColor = Color(0xFF505050); //
const Color appTextColor = Color(0xFFFFFFFF); //
Color appTextColorSecondary = const Color(0xFFFFFFFF).withOpacity(0.56); //
Color appDialogBackgroundColor = const Color(0xFFFFFFFF); //
...
const Color appErrorBackgroundColor = Color(0xFF3C190A); //
const Color appIconColor = Color(0xFF8D8D93); //
const Color appAccentIconColor = Color(0xFF717880);
const Color labelColor = Color(0xFFB3B3B3); //
const Color appInputFillColor = Color(0xFF282F35); //
const Color snackBarBackgroundColor = Color(0xFF142D1A); //
const Color appFocusInputBorderColor = Color(0xFFEAEBEC);
Color colorSchemaBackgroundColor = const Color(0xFF1D2124); //
const Color colorSchemaPrimaryColor = Color(0xFFB3B3B3); //
const Color colorSchemeOnPrimaryColor = Color(0xFF00C802); //
const Color colorSchemeOnSecondaryColor = Color(0xFFFE4E02); //
const Color colorSchemeOnErrorColor = Color(0xFFFE4E02); //
...
ThemeData darkTheme() {
  return ThemeData(
    ...
    shadowColor: appBackgroundColorSecondary,
