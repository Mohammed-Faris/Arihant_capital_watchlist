...
class PlFOScreen extends BaseScreen {
  const PlFOScreen({Key? key}) : super(key: key);

  @override
  State<PlFOScreen> createState() => _PlFOScreenState();
}

class _PlFOScreenState extends BaseAuthScreenState<PlFOScreen> {
